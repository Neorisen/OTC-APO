local defaultOptions = {
  ...
  showRightSecondPanel = true,
  foregroundFrameRate = 0,
  backgroundFrameRate = 150,
  painterEngine = 0,
  enableAudio = true,
...
function setOption(key, value, force)
  ...
  elseif key == 'showExpSpeed' then
    modules.client_topmenu.setExpSpeedVisible(value)
  ...
  elseif key == 'showHealthManaCircle' then
    modules.game_hotkeys.healthCircle:setVisible(value)
    modules.game_hotkeys.healthCircleFront:setVisible(value)
    modules.game_hotkeys.manaCircle:setVisible(value)
    modules.game_hotkeys.manaCircleFront:setVisible(value)
  ...
  elseif key == 'topHealtManaBar' then
    modules.game_hotkeys.topHealthBar:setVisible(value)
    modules.game_hotkeys.topManaBar:setVisible(value)
    modules.game_hotkeys.topExperienceBar:setVisible(value)							   									
